...
1. Create project subfolder:
   - mkdir -p {output_folder}/{project-name}
2. Determine output path:
   - {output_folder}/{project-name}/{workflow-name}.md
   - Example: docs/myapp/prd.md
3. Write content to path
4. Return file path for status update

Note: Date-stamped flat files (e.g., docs/prd-myapp-2025-01-11.md) are legacy format.
New documents always use the project subfolder structure.
```
...
Example:
✓ Phase 1: Analysis
  ✓ product-brief (docs/myapp/product-brief.md)
  - research (optional)
