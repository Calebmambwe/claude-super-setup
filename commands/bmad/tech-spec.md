...
**Output:** `docs/{project-name}/tech-spec.md`
...
3. **Load product brief** if exists:
   - Check `docs/*/product-brief.md` (new format)
   - If not found, fall back to `docs/product-brief-*.md` (legacy format)
   - If legacy found, log: "Legacy format detected. Consider: `mv docs/product-brief-{name}.md docs/{name}/product-brief.md`"
...
3. **Determine output path:** `{output_folder}/{project-name}/tech-spec.md`
