...
**Output:** `docs/{project-name}/sprint-plan.md`, `.bmad/sprint-status.yaml`
...
3. **Load planning documents:**
   ...
   - If Level 2+, load architecture: `docs/*/architecture.md` (new format), fall back to `docs/architecture-*.md` (legacy)
...
**Save document:**
- Path: `{output_folder}/{project-name}/sprint-plan.md`
- Use Write tool
