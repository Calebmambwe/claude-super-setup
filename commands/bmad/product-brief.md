...
**Output:** `docs/{project-name}/product-brief.md`
...
3. **Determine output path** per `helpers.md#Save-Output-Document`:
   - Format: `{output_folder}/{project-name}/product-brief.md`
   - Example: `docs/myapp/product-brief.md`
...
3. Update status to file path: `"docs/{project-name}/product-brief.md"`
