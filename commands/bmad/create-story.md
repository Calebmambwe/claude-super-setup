...
**Output:** `docs/{project-name}/stories/STORY-{ID}.md`
...
3. **Load sprint plan** (if exists): `docs/*/sprint-plan.md` (new format), fall back to `docs/sprint-plan-*.md` (legacy)
...
**Save document:**
- Path: `docs/{project-name}/stories/STORY-{ID}.md`
- Use Write tool
...
Document: docs/{project-name}/stories/STORY-{ID}.md
